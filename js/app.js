...
function updateGroundTotals(){if(!DESIGN?.resolveGroundFeatures)return;const totals=groundFeatureTotals(DESIGN.resolveGroundFeatures(STATE.activePlan)),areas=totals.areaByMaterial,green=(areas['area-lawn']||0)+(areas['area-clover']||0),gravel=(areas['area-gravel']||0)+(areas['area-yard-gravel']||0),garden=(areas['area-vegetable']||0)+(areas['area-flower-bed']||0)+(areas['area-herb']||0);$('groundTotals').innerHTML=`<strong>地表集計</strong><dl><dt>園路延長</dt><dd>${totals.pathLength.toFixed(1)}m</dd><dt>園路面積</dt><dd>${totals.pathArea.toFixed(1)}㎡</dd><dt>芝・クローバー</dt><dd>${green.toFixed(1)}㎡</dd><dt>砂利</dt><dd>${gravel.toFixed(1)}㎡</dd><dt>菜園・花壇</dt><dd>${garden.toFixed(1)}㎡</dd><dt>防草</dt><dd>${(areas['area-weed-control']||0).toFixed(1)}㎡</dd></dl>`}
